...
- non_formalized.svh_1.number: "0000080" (решение оператора: использовать № отчета ДО-1 для G_30P_1)
- non_formalized.svh_1.date: "03.02.2026" (решение оператора: дата отчета ДО-1 для G_30P_1)
- formalized.packing_list_1.DeliveryTerms_Contract_PrDocumentName: "ДОГОВОР КУПЛИ-ПРОДАЖИ" (решение оператора; нормализовано в UQI поля схемы)
- formalized.contract_1.ContractTerms_Amount: "270000.00" (решение оператора: вариант B; нормализовано в UQI поля схемы)
