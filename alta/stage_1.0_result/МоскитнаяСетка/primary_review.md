...
- **Всего обработано документов:** 13 (md) + 4 (stable_source)
- **Всего сформировано полей:** 828 (total_fields)
- **Количество конфликтов:** 2 (разрешены решениями оператора)
...
- Валюта инвойса RMB vs CNY — применено решение оператора: CNY (CO)
- Сумма контракта 41904.30 vs 270000.00 — применено решение оператора: 270000.00 (CO)
