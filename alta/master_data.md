...
- `letter_of_attorney.doc_name`: ДОВЕРЕННОСТЬ
...
- `declarant.inn`: 1650389298
- `declarant.kpp`: 165001001
- `declarant.postal_code`: 423800
- `declarant.country_code`: RU
- `declarant.country_name`: РОССИЯ
- `declarant.region`: РЕСПУБЛИКА ТАТАРСТАН
- `declarant.city`: НАБЕРЕЖНЫЕ ЧЕЛНЫ
- `declarant.street_house`: ПРОЕЗД ХЛЕБНЫЙ, Д. 30, ОФИС 211
- `declarant.phone`: +7 (843) 207 18 90
