...
note: Обновлено по operator_provided_data.md (2026-04-12): все отсутствующие в первичке поля закрыты решениями оператора; pending устранены.
...
- status: confirmed
- note: В документе JING LI без отчества (operator decision: middle name пусто).
...
| ForeignPerson_ShortName | HEBEI LANGMAI IMPORT AND EXPORT CO., LTD | confirmed_operator | решение оператора: ShortName=OrganizationName |
| ForeignPerson_Address_CountryCode | CN | confirmed_document | |
| ForeignPerson_Address_CounryName | CHINA | confirmed_document | |
| ForeignPerson_Address_Region | HEBEI | confirmed_document | |
| ForeignPerson_Address_City | SHIJIAZHUANG | confirmed_document | |
...
| PersonMiddleName |  | confirmed_operator | решение оператора: пусто |
...
- status: confirmed
- note: Consignor/Consignee закрыты решением оператора (consignor=seller, consignee=buyer). Веса по строкам и итоги gross/net взяты из PL по решению оператора.
...
| DeliveryTerms_TradingCountryCode | CN | confirmed_operator | решение оператора |
...
| Consignor_OrganizationName | HEBEI LANGMAI IMPORT AND EXPORT CO.,LTD. | confirmed_operator | решение оператора: consignor=seller |
| Consignor_Address_CountryCode | CN | confirmed_operator | решение оператора: consignor=seller |
| Consignor_Address_CounryName | China | confirmed_operator | решение оператора: consignor=seller |
| Consignor_Address_Region | Hebei | confirmed_operator | решение оператора: consignor=seller |
| Consignor_Address_City | Shijiazhuang | confirmed_operator | решение оператора: consignor=seller |
| Consignor_Address_StreetHouse | No. 5 Gaodong street | confirmed_operator | решение оператора: consignor=seller |
| Consignee_OrganizationName | LLC «SKIF» | confirmed_operator | решение оператора: consignee=buyer |
| Consignee_OGRN | 1201600020390 | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_INN | 1650389298 | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_KPP | 165001001 | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_Address_PostalCode | 423800 | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_Address_CountryCode | RU | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_Address_CounryName | Russia | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_Address_Region | Republic of Tatarstan | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_Address_City | Naberezhnye Chelny | confirmed_operator | решение оператора: stable_source (EGRUL) |
| Consignee_Address_StreetHouse | Khlebny Passage, hause 30, office 211 | confirmed_operator | решение оператора: stable_source (EGRUL) |
...
| Consignor_ShortName | HEBEI LANGMAI IMPORT AND EXPORT CO.,LTD. | confirmed_operator | решение оператора: ShortName=OrganizationName |
...
| Consignee_ShortName | LLC «SKIF» | confirmed_operator | решение оператора: ShortName=OrganizationName |
...
| DeliveryTerms_DeliveryPlace | Naberezhnye Chelny | confirmed_operator | решение оператора: как в invoice/PL |
| DeliveryTerms_DeliveryTermsStringCode | EXW | confirmed_operator | решение оператора: как в invoice/PL |
...
| Consignor_Address_City | Shijiazhuang | confirmed_document | |
| Consignor_Address_StreetHouse | No. 5 Gaodong street | confirmed_document | |
| Consignor_Guarantee_OrganizationName | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
| Consignor_Guarantee_ShortName | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
| Consignor_Guarantee_Address_CountryCode | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
| Consignor_Guarantee_Address_CounryName | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
| Consignor_Guarantee_Address_Region | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
| Consignor_Guarantee_Address_City | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
| Consignor_Guarantee_Address_StreetHouse | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
...
| field | value | status | note |
|---|---|---|---|
| DocumentSign | 1 | confirmed_operator | решение оператора |
...
| Signature_Choice | 1 | confirmed_operator | решение оператора |
...
| field | value | status | note |
|---|---|---|---|
| PrDocumentNumber | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
| PrDocumentDate | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |

#### Consignor_SubjectAddressDetails
| field | value | status | note |
|---|---|---|---|
| PostalCode | ОТСУТСТВУЕТ | confirmed_operator | решение оператора: в seller адресе индекс не указан |
| CountryCode | CN | confirmed_operator | решение оператора: consignor=seller |
| CounryName | China | confirmed_operator | решение оператора: consignor=seller |
| Region | Hebei | confirmed_operator | решение оператора: consignor=seller |
| Town | Shijiazhuang | confirmed_operator | решение оператора: consignor=seller |
| StreetHouse | No. 5 Gaodong street | confirmed_operator | решение оператора: consignor=seller |
...
| House | 30 | confirmed_operator | решение оператора |
| Room | 211 | confirmed_operator | решение оператора |
...
| ServiceName | ОТСУТСТВУЕТ | confirmed_operator | решение оператора |
