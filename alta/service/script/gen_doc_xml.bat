@echo off
:: =========================================================================
:: Запуск генератора XML формализованных документов (gen_doc_xml.ps1)
::
:: Использование: gen_doc_xml.bat <ИмяКейса>
:: Пример:        gen_doc_xml.bat МоскитнаяСетка
:: =========================================================================
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0gen_doc_xml.ps1" -CaseName "%CASE_NAME%" -HobotRoot "%HOBOT_ROOT%"
