...
- **ИСКЛЮЧЕНИЕ: ЗАПРЕЩЕНА АГРЕГАЦИЯ ТОВАРОВ ИЗ СПИСКА 257**, см. `### 5.3 Товары, запрещенные к группировке`.
...
### 5.3 Товары, запрещенные к группировке
...
отдельными позициями:
  - Алкоголь;
  - нефтепродукты и химия;
  - автомобильные шины;
  - компьютерная техника;
  - бытовая техника;
  - электроника и связь;
  - транспорт и плавсредства.
