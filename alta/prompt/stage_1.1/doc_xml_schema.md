...
### 1. Invoice (04021) — AltaE2I

#### 1.1) Заголовок / реквизиты
...
### 1.2) InvoiceGoods (повторяющийся блок)
...
### 2) Packing List (04131) — AltaE2PACK

#### 2.1) Заголовок / реквизиты
...
#### 2.3) TransportMeans (повторяющийся блок)
...
#### 3.2) CMRGoods (повторяющийся блок)
...
#### 3.3) GoodsPackingInfo (вложенный блок внутри CMRGoods)
...
### 4) Payment Order (04023) — AltaPaymentOrder
...
### 5. Service Invoice (04031) — AltaServiceInvoice
...
#### 5.4) Consignor_SubjectAddressDetails (вложенный блок)
...
#### 5.5) Consignee_SubjectAddressDetails (вложенный блок)
...
#### 5.6) ServiceDescription (повторяющийся блок)
