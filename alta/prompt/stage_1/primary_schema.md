...
- `alta\source\<ИмяКейса>\master_data.md` - данные, мало изменяющиеся между кейсами (declarant, representative, letter_of_attorney, 
  contract, supplementary_contract, unk, transport_contract, exemption_letter),
...
1) Найди следующие файлы, выясни их размеры: 
  - `alta\source\<ИмяКейса>\...\<папка первички>\md\*.md`,
  - `alta\source\<ИмяКейса>\master_data.md`,
...
3) Проверь наличие исходных документов:
