...
1. Правила описывают, как нормализованный документ из `Documents package` проецируется в запись графы 44.
...
### Специализация общего шаблона Mapping Rule
