...
- `description`: берется из текста в скобках в реквизитах шаблонов
...
- **Подписи**
  - 32: `Signature_Choice` (вариант подписи: 1 - заполняются только реквизиты ИП;2 - заполняются 
    только реквизиты руководителя и бухгалтера)
  - 33: `IndividualEntrepreneur_PersonSurname` (фамилия ИП)
  - 34: `IndividualEntrepreneur_PersonName` (инициал/имя ИП)
  - 35: `IndividualEntrepreneur_PersonMiddleName` (инициал/отчество индивидуального предпринимателя)
  - 36: `SignatureDirectorChiefAccountant_Director_PersonSurname` (фамилия руководителя)
  - 37: `SignatureDirectorChiefAccountant_Director_PersonName` (инициал/имя руководителя)
  - 38: `SignatureDirectorChiefAccountant_Director_PersonMiddleName` (инициал/отчество руководителя)
  - 39: `SignatureDirectorChiefAccountant_ChiefAccountant_PersonSurname` (фамилия бухгалтера)
  - 40: `SignatureDirectorChiefAccountant_ChiefAccountant_PersonName` (инициал/имя бухгалтера)
  - 41: `SignatureDirectorChiefAccountant_ChiefAccountant_PersonMiddleName` (инициал/отчество бухгалтера)
...
#### 1.8. Insurance Document / Счет за страховку (04111)
...
#### 1.15. EGRUL / Выписка из ЕГРЮЛ (04011)
...
как минимум одним элементом и ставить `pending` в `tnved/places/gross_weight_kg/cost/currency_code`, с фиксацией в
разделе нерешенных вопросов.
...
Не обязательно в документах поставки.
...
7) **Зафиксируй ответы в `operator_provided_data.md`**. Применяй патчи к данным оператора либо после ответа на 
