...
- **Подписи** (системный блок структуры Альты; для импорта/совместимости):
  - 32: `Signature_Choice` (вариант подписи: 1 - инд. предприниматель, 2 - руководитель + бухгалтер)
  - 33: `IndividualEntrepreneur_PersonSurname` (фамилия инд. предпринимателя)
  - 34: `IndividualEntrepreneur_PersonName` (инициал/имя инд. предпринимателя)
