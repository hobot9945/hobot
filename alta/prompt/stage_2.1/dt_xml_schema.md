...
#### 2.3.2. G44 (повторяющиеся блоки документов)
...
Системные теги (`BACK`, `ED_TYP`, `ED_ID`, `ED_STAT`, `FACE`, `DOCTEXT`) **не генерировать**.

#### 2.3.3. Блок G_31 (описание товара)
...
#### 2.3.4. TXT (дополнение к графе 31)
